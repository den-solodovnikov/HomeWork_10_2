...
+Модуль transactions_from_csv_xls
содержит функции считывания финансовых операций из CSV и EXCEL файлов, 
принимая на вход путь к расположению файлов данных форматов (CSV, EXCEL)
и выдают список словарей с транзакциями.

**read_transactions_from_csv(path_name: str) -> list[dict]:**
принимает путь к файлу CSV и выдает список словарей с транзакциями.

**read_transactions_from_xls(path_name: str) -> list[dict]:**
принимает путь к файлу XLS и выдает список словарей с транзакциями

+Модуль summary_data.py
содержит функции поиска и подсчета транзакций

**search_description(transactions: list[dict], descript_word: str) -> list[dict]:**
...
**count_transactions(transactions: list[dict], categories: list[str]) -> dict:**
